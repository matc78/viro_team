/// Notification "événement mis à jour" (changement d'heure, de date, etc.).
/// Payload : clubId, eventId, title, eventType, dateId, startTime, location, clubName.
class EventUpdateNotification {
  EventUpdateNotification._();

  static const String type = 'event_update';
